...
class DefaultLayout(jp.QLayout):
    ...
    def __int__(self, view="hHh lpR fFf", **kwargs):
        ...
        jp.QBtn(a=toolbar, dense=True, flat=True, round=True, icon="menu",
                click=self.toggle_left_drawer, drawer=drawer)
        jp.QToolbarTitle(a=toolbar, text="Instand Dictionary")

    @staticmethod
    def toggle_left_drawer(widget, msg):
